...
#zp=rpool
zp=zfs3nvme1T
# xxx TODO EDITME # NOTE this zpool is SSD-based 
...
isofile=/ztoshtera6macpromir/shrcompr-ztoshtera6/ISO/proxmox-ve_8.1-2.iso
#isofile=""
...
# xxx updated 2025.0209, zfs 2.2.x
#encrline=$(man zfs|grep "encryption=" |head -n 1 |sed 's/|/,/g') # |sed 's/off,on,//g')
encrline=$(man zfsprops|grep "encryption=" |head -n 1 |sed 's/|/,/g') # |sed 's/off,on,//g')
...
loggit "o Supported ZFS encryption types (per ' man zfsprops ')"
loggit "$encrline"
